                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Container(
                          child: Text("Sign In",style: TextStyle(fontSize: 15.sp,color: Colors.black,fontWeight: FontWeight.bold),textAlign: TextAlign.left,),
                        ),
                        Container(
                          margin: EdgeInsets.only(top: 10),
                          child: Text("This is an example of a sign in page written in Flutter.",style: TextStyle(fontSize: 5.sp,fontWeight: FontWeight.w200,color: Colors.grey,),textAlign: TextAlign.left,),
                        ),
                        SizedBox(height: 50,),
                        Container(
                            padding:
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(width: 10,),
                                          Text("Sign In With Google",style: TextStyle(fontSize: 4.sp,color: Colors.purple.shade900),)
                                        ],
                                      ),
                                    ),
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(width: 10,),
                                          Text("Sign In With Apple",style: TextStyle(fontSize: 4.sp,color: Colors.purple.shade900),)
                                        ],
                                      ),
                                    ),
                                    onPressed: (){},
